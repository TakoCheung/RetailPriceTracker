...
from app.models import Product, Provider, User
...
class TestCustomExceptions:
    ...
    def test_external_service_error(self):
        ...
        assert error.message == "External service 'price_scraper' error: Connection timeout"
...
class TestHealthCheckSystem:
    ...
    async def test_health_check_with_failures(self, db_session: AsyncSession):
        ...
        with patch.object(service, 'check_cache_health') as mock_cache:
            ...
            cache_result = next(c for c in result["components"] if c["component"] == "cache")
...
class TestErrorMetrics:
    ...
    def test_error_trend_analysis(self):
        ...
        assert trends["EXTERNAL_SERVICE_ERROR"]["trend"] in ["increasing", "stable", "decreasing"]
    ...
    def test_error_alerting_thresholds(self):
        ...
        service.set_error_threshold("EXTERNAL_SERVICE_ERROR", count=5, time_window_minutes=5)
