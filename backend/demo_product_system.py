...
class MockAsyncSession:
    ...
    def __init__(self):
        self.data = {
            'products': [
                {
                    'id': 1, 'name': 'iPhone 15 Pro', 'brand': 'Apple', 'category': 'Electronics',
                    'current_price': 999.99, 'is_active': True, 'deleted_at': None
                },
                {
                    'id': 2, 'name': 'Samsung Galaxy S24', 'brand': 'Samsung', 'category': 'Electronics',
                    'current_price': 899.99, 'is_active': True, 'deleted_at': None
                },
                {
                    'id': 3, 'name': 'MacBook Pro M3', 'brand': 'Apple', 'category': 'Computers',
                    'current_price': 1999.99, 'is_active': True, 'deleted_at': None
                }
            ],
            'price_records': [
                {'product_id': 1, 'price': 999.99, 'created_at': '2024-01-15T10:00:00Z'},
                {'product_id': 1, 'price': 949.99, 'created_at': '2024-01-20T10:00:00Z'},
                {'product_id': 2, 'price': 899.99, 'created_at': '2024-01-15T10:00:00Z'},
            ]
        }
...
class DemoProductService:
    ...
    async def create_product(self, db_session, name: str, brand: str = None, category: str = None, **kwargs):
    ...
    async def search_products(self, db_session, category: str = None, brand: str = None, 
                            min_price: float = None, max_price: float = None, 
                            page: int = 1, page_size: int = 20, **kwargs):
        """Demo: Search products with filters."""
        products = [
            {'id': 1, 'name': 'iPhone 15 Pro', 'brand': 'Apple', 'category': 'Electronics', 'price': 999.99},
            {'id': 2, 'name': 'Samsung Galaxy S24', 'brand': 'Samsung', 'category': 'Electronics', 'price': 899.99},
            {'id': 3, 'name': 'MacBook Pro M3', 'brand': 'Apple', 'category': 'Computers', 'price': 1999.99}
        ]
    ...
    async def add_price_record(self, db_session, product_id: int, price: float, provider_id: int):
