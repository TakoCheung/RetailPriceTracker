...
class ErrorHandlerMiddleware(BaseHTTPMiddleware):
    ...
    def format_custom_error_response(self, exc: BaseAPIException, error_id: str) -> Dict[str, Any]:
    ...
    def format_unexpected_error_response(self, exc: Exception, error_id: str) -> Dict[str, Any]:
